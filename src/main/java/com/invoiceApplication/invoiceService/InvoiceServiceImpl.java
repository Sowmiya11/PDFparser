...
public class InvoiceServiceImpl implements InvoiceServiceInter {
    ...
    public InvoiceServiceImpl() throws Exception{
    ...
    public void statusUpdationForRequestedInvoiceNo(String userName, String password, String invoiceNo) throws SQLException {
        if (invoiceDataBase.updatingStatusForInvoiceNumber(invoiceNo) > 0) {
            ...
            //} else
            //  to = userName;
            to = invoiceDataBase.replyMailID(invoiceNo);
            ...
            if (to != null) {
                try {
                    ...
                    System.out.println(SMTPMailConstants.SEND_SUCCESSFULL);

                } catch (MessagingException e) {
                    e.printStackTrace();
                }
            } else {
                System.out.println(SMTPMailConstants.INVALID_NO_FOUND);
            }
        } else {
            System.out.println(SMTPMailConstants.INVALID_NO_FOUND);
        }
